...
- `VITE_ENABLED_TRANSPORT_MODES`: A comma-separated list of transport modes to be displayed in the interface, controlling the available options for selection. The following modes are available: `car`, `cargo_bike`, `scooter`, `van`, `truck_75`, `truck_10`, `truck_12`, `truck_19`, `truck_26`, `truck_32`, `truck_44`, `bicycle`, `foot`. The default value is `car,cargo_bike,scooter,van,truck_19`. For a complete list of modes, refer to the Router API at https://router.cartoway.com/0.1/capability.
